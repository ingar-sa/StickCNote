...
cl %CommonCompilerFlags% %AppFileOutputs% src/scn.cpp /LD %CommonLinkerFlags% /PDB:%BuildFolder%\app_%random%.pdb /EXPORT:UpdateBackBuffer /EXPORT:RespondToMouse /EXPORT:RespondToKeyboard /EXPORT:SeedRandPcg
